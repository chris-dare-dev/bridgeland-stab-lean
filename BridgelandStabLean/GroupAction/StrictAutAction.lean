...
/-!
# A strict group of triangulated autoequivalences acting on slicings
...
`notes/anchor-api-map.md` §7 records the trade.

## What it does cover

Everything hard is already in `AutAction.lean` — `PostnikovTower.mapF`,
